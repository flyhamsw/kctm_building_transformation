...
if __name__ == '__main__':
    ...
    data, global_shift = import_data('data/sewoon_west.txt')
    n = fit_plane(data)
    ...
    transformation_matrix = np.array([k, l, n])

    data_tranformed = np.dot(transformation_matrix, data.T).T

    with open('data/sewoon_west_transformed_.txt', 'w') as f:
