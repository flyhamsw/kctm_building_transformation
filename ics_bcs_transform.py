...
def transform_bcs_to_ics(x_bcs, y_bcs, transform_parameters):
    x_ics = x_bcs / transform_parameters['x_gsd'] - transform_parameters['ul_x']
    y_ics = y_bcs / transform_parameters['y_gsd'] - transform_parameters['ul_y']
    return x_ics, y_ics
...
transform_mat = load_transform_mat('data/sewoon_west_transform_mat.pickle')
ul_bcs = transform_kctm_to_bcs(199560.8405, 552233.9363, 53.0, transform_mat)
lr_bcs = transform_kctm_to_bcs(199561.2618, 552230.3453, 47.0, transform_mat)
